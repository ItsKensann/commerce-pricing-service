...
# ones.
extensions = [
    "recommonmark",  # Required to process markdown as markdown instead of RST
    "sphinx_markdown_tables",  # Required for markdown tables to be handled correctly
]  # type: List[str]
...
project = "eis-self-service"
copyright = "2022, Columbia Sportswear"
